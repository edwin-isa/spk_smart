        ...
        <div class="w-full max-w-full px-3 flex-0">
          ...
          <nav class="absolute top-0 left-0 right-0 z-30 flex flex-wrap items-center px-4 py-2 m-6 mb-0 shadow-sm rounded-xl bg-white/80 backdrop-blur-2xl backdrop-saturate-200 lg:flex-nowrap lg:justify-start">
            <div class="flex items-center justify-between w-full p-0 px-6 mx-auto flex-wrap-inherit">
              <marquee class="py-1.75 text-sm mr-4 ml-4 whitespace-nowrap font-bold text-slate-700 lg:ml-0" target="_blank">Implementasi Metode Simple Multi Attribute Rating Technique (SMART) Pada Sistem Pendukung Keputusan Penerimaan Beasiswa Oleh Kelompok 4 TI 3D: Maria Fadilla - Mirabell Joice Laura - M Edwin Isa Alfais</marquee>
